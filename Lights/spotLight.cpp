...
SpotLight::SpotLight(Primitive *p, std::string name)
	: LightNode(p, name)
{
	std::cout << "Creating SpotLight" << std::endl;
	m_shadowWidth = 512;
	m_shadowHeight = 512;
...
void SpotLight::changeColor(float r, float g, float b, float a) {
	color[0] = r;
	color[1] = g;
	color[2] = b;
	color[3] = a;
